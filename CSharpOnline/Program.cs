...
namespace CSharpOnline
{
    class Program
    {
        ...
        static void MyLesson18Exercises()
        {
            Lesson18Exercises myWork = new Lesson18Exercises();
            myWork.BirthYearLeapYear();
        }
        ...
        static void MyLesson16Exercises()
        {
            Lesson16Exercises myWork = new Lesson16Exercises();
            myWork.Question1Televisions();
            myWork.Question2Houses();
        }
